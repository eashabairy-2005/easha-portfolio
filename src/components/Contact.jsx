        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-10 items-center">
          ...
          >
            ...
            <textarea
              ...
              className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg text-sm sm:text-base border focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 transition-all mb-4 sm:mb-5 resize-none"
              required
            ></textarea>
            ...
            <button
              ...
              className="w-full py-3 rounded-lg text-white font-semibold hover:shadow-lg hover:shadow-orange-500/25 transition-all duration-300"
            >
              Send Message
            </button>
